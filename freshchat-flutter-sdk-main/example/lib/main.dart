...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static const String APP_ID = "d911eb54-8a38-4853-85f4-a77372e845da", APP_KEY = "ab020961-a310-4c44-8f18-954a68f142bb", DOMAIN = "msdk.in.freshchat.com";
  void initState() {
    super.initState();
  ...
  void _incrementCounter() {
    ...
    setState(() {
      ...
      freshchatUser?.setFirstName('Jaydeep');
      freshchatUser?.setLastName('Sanghani');
      freshchatUser?.setEmail('vijay@gmail.com');
      freshchatUser?.setPhone('91', '9537888243');
      Freshchat.setUser(user: freshchatUser);
    });
    print('USER FIRST NAME ======${freshchatUser?.getFirstName()}');
  }
