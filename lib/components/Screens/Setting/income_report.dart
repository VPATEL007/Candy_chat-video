...
class _IncomeReportState extends State<IncomeReport> {
  ...
  void initState() {
    for (int i = 0;
        i < daysInRange.call(DateTime(2022, 07, 01), DateTime(2023)).length;
        i++) {
      DateTime datetime = DateTime.now();

      if (daysInRange
              .call(DateTime(2022, 07, 01), DateTime(2023))[i]
              .toIso8601String()
              .substring(0, 10) ==
                          ...
                          onTap: () {
                            setState(() {
                              ...
                              Provider.of<DailyEarningDetailProvider>(context,
                                      listen: false)
                                  .dailyEarningReportModel = null;
                              selectedIndex = index;
                              selectedDate = daysInRange
                                  .call(DateTime(2022, 07, 01),
                                      DateTime(2023))[index]
                                  .toIso8601String();
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  color: ColorConstants.greyC4Color
                                      .withOpacity(0.60)),
                              getIncomeButtonText(
                                  title2: value.weeklyEariningReportModel
                                          ?.rankingBonus ??
                                      0,
                                  title: 'Ranking bonus',
                                  isDownArrow: true),
                              getIncomeButtonText(
                                title: 'Salary',
                                title2:
                                    value.weeklyEariningReportModel?.salary ??
                                        0,
                              ),
                              Padding(
                                padding: EdgeInsets.symmetric(
