...
//  Support
  ...
  const ScreenTitle({
    ...
    this.enableLocationDesc = 'Enable location to start shift'
        ' and allow demus to access your '
        'location even when you are'
        ' not using the app.',
    this.enableLocationDescIOS =
        'Enable location to start shift and allow demus to access your location.',
    ...
    this.enableLocationEndDesc =
        'Enable location to end shift and allow demus to access your location even when you are not using the app?',
    this.rideStartLocDesc = 'Enable location to start log timer and allow demus to access your location even when you are not using the app?',
    this.rideEndLocDesc = 'Enable location to end log timer and allow demus to access your location even when you are not using the app?',
